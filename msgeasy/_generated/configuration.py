...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.msgeasy.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("msgeasy._generated")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://api.msgeasy.com",
                'description': "Production",
            },
            {
                'url': "https://api-dev.msgeasy.com",
                'description': "Dev",
            }
        ]
