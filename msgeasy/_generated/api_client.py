...
from msgeasy._generated.api_response import ApiResponse, T as ApiResponseT
import msgeasy._generated.models
from msgeasy._generated import rest
from msgeasy._generated.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(msgeasy._generated.models, klass)
